...
# (agent, init .rc, nowhere.conf, boot animation) get baked in, WITHOUT a full brunch.
...
find out/target/product/FP3/system \( -name nowhere_agent -o -name bootanimation.zip -o -name 'diaspore*.rc' -o -name nowhere.conf \) 2>/dev/null
